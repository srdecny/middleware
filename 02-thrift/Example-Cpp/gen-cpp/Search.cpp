...
Search_search_args::~Search_search_args() noexcept {
}


uint32_t Search_search_args::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t Search_search_args::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("Search_search_args");
...
Search_search_pargs::~Search_search_pargs() noexcept {
}


uint32_t Search_search_pargs::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("Search_search_pargs");
...
Search_search_result::~Search_search_result() noexcept {
}


uint32_t Search_search_result::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t Search_search_result::write(::apache::thrift::protocol::TProtocol* oprot) const {

  uint32_t xfer = 0;

  xfer += oprot->writeStructBegin("Search_search_result");
...
Search_search_presult::~Search_search_presult() noexcept {
}


uint32_t Search_search_presult::read(::apache::thrift::protocol::TProtocol* iprot) {
...
void SearchClient::search(SearchState& _return, const std::string& query, const int32_t limit)
{
  send_search(query, limit);
  recv_search(_return);
}

void SearchClient::send_search(const std::string& query, const int32_t limit)
{
  int32_t cseqid = 0;
  oprot_->writeMessageBegin("search", ::apache::thrift::protocol::T_CALL, cseqid);

  Search_search_pargs args;
  args.query = &query;
  args.limit = &limit;
  args.write(oprot_);
...
void SearchClient::recv_search(SearchState& _return)
{
...
void SearchClient::fetch(FetchResult& _return, const SearchState& state)
{
  send_fetch(state);
  recv_fetch(_return);
}

void SearchClient::send_fetch(const SearchState& state)
{
  int32_t cseqid = 0;
...
void SearchProcessor::process_search(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  void* ctx = nullptr;
  if (this->eventHandler_.get() != nullptr) {
    ctx = this->eventHandler_->getContext("Search.search", callContext);
  }
  ::apache::thrift::TProcessorContextFreer freer(this->eventHandler_.get(), ctx, "Search.search");

  if (this->eventHandler_.get() != nullptr) {
    this->eventHandler_->preRead(ctx, "Search.search");
  }

  Search_search_args args;
  args.read(iprot);
  iprot->readMessageEnd();
  uint32_t bytes = iprot->getTransport()->readEnd();

  if (this->eventHandler_.get() != nullptr) {
    this->eventHandler_->postRead(ctx, "Search.search", bytes);
  }

  Search_search_result result;
  try {
    iface_->search(result.success, args.query, args.limit);
    ...
    if (this->eventHandler_.get() != nullptr) {
      this->eventHandler_->handlerError(ctx, "Search.search");
    }
  ...
  if (this->eventHandler_.get() != nullptr) {
    this->eventHandler_->preWrite(ctx, "Search.search");
  }
  ...
  if (this->eventHandler_.get() != nullptr) {
    this->eventHandler_->postWrite(ctx, "Search.search", bytes);
  }
}
...
void SearchProcessor::process_fetch(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  ...
  try {
    iface_->fetch(result.success, args.state);
    result.__isset.success = true;
  } catch (ProtocolException &protocolException) {
    result.protocolException = protocolException;
    result.__isset.protocolException = true;
...
void SearchConcurrentClient::search(SearchState& _return, const std::string& query, const int32_t limit)
{
  int32_t seqid = send_search(query, limit);
  recv_search(_return, seqid);
}

int32_t SearchConcurrentClient::send_search(const std::string& query, const int32_t limit)
{
...
void SearchConcurrentClient::recv_search(SearchState& _return, const int32_t seqid)
{
...
void SearchConcurrentClient::fetch(FetchResult& _return, const SearchState& state)
{
  int32_t seqid = send_fetch(state);
  recv_fetch(_return, seqid);
}

int32_t SearchConcurrentClient::send_fetch(const SearchState& state)
{
  int32_t cseqid = this->sync_->generateSeqId();
  ::apache::thrift::async::TConcurrentSendSentry sentry(this->sync_.get());
  oprot_->writeMessageBegin("fetch", ::apache::thrift::protocol::T_CALL, cseqid);
